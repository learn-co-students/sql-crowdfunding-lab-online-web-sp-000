...
def selects_the_category_names_and_pledge_amounts_of_all_pledges_in_the_music_category
  "select category, pledges.amount from projects inner join pledges on pledges.project_id = projects.id where projects.category = 'music';"
end

def selects_the_category_name_and_the_sum_total_of_the_all_its_pledges_for_the_books_category
  "select category, sum(pledges.amount) from projects inner join pledges on pledges.project_id = projects.id where projects.category = 'books' group by projects.category;"
end
