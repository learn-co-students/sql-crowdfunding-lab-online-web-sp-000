...
def selects_the_titles_of_all_projects_and_their_pledge_amounts_alphabetized_by_title
  ...
  #tell the pledges table to give me the project ID and the amount pledged associated with it 
  #then i would say get me the project name associated the id
  #then organise those in alphabetical order
end
