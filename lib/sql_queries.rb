...
def selects_the_titles_of_all_projects_and_their_pledge_amounts_alphabetized_by_title
  "SELECT projects.title, SUM (pledges.amount) AS pledges_amount FROM projects
...
def selects_the_user_name_age_and_pledge_amount_for_all_pledges_alphabetized_by_name
  "SELECT users.name, users.age, SUM(pledges.amount) AS pledges_amount FROM users 
...
def selects_the_category_names_and_pledge_amounts_of_all_pledges_in_the_music_category
  "SELECT projects.category, pledges.amount AS pledges_amount FROM projects
  JOIN pledges ON pledges.project_id = projects.id
...
def selects_the_category_name_and_the_sum_total_of_the_all_its_pledges_for_the_books_category
  "SELECT projects.category, SUM(pledges.amount) AS pledges_total FROM projects
  JOIN pledges ON pledges.project_id = projects.id
