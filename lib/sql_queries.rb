...
def selects_the_titles_of_all_projects_and_their_pledge_amounts_alphabetized_by_title
  ...
  JOIN pledges ON pledges.project_id = projects.id GROUP BY (pledges.project_id) ORDER BY projects.title"
end
...
def selects_the_titles_and_amount_over_goal_of_all_projects_that_have_met_their_funding_goal
  "SELECT projects.title, (SUM(pledges.amount)-projects.funding_goal) AS total_pledges FROM projects
